...
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://192.168.6.136:8080"/> --> 
<!-- <input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.6.136:8080/mvc"/> -->
<input type="hidden" id="apiServer" name="apiServer" value="http://49.234.159.164:8088/dev"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://49.234.159.164:8088/mvc"/>
